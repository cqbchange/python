    ...
    ( () => {
        ...
        d.f.j = (a, c) => {
            ...
            if (0 !== f)
                if (f)
                    c.push(f[2]);
                else if (/^(90(560|867)|(5018|5351|6275)0|21581|31038|38473|40376|88784|89727)$/.test(a))
                    e[a] = 0;
                else {
...
//# sourceMappingURL=runtime~app.ac64f45a.js.map
var t = window.loader(757026)
console.log(t.default(123456))