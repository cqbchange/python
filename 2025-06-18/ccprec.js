...
//    var aes = new g;
//    ``
//    var a = '{"id":"rtvgyzntje8v4eut","projectKey":"honsan_cloud_ccprec","clientKey":"rtvgyzn6jgw62lnx","token":null,"clientDailyData":{},"acts":[{"id":"rtvgyznt9dcgvsio","fullPath":"/ccprec.com.cn.web/api/v3/web/addVisitsStatistics","args":["/index/projectSecPage/cqzr",1]},{"id":"rtvgyznterk2zlok","fullPath":"/ccprec.com.cn.web/client/info/cqweb_nonphy_cqzr","args":[$`{page}`,20,null]}]}'
//    return aes.decode(a)
// }
function get_data(page){
    a = `{"id":"rtvgyzntje8v4eut","projectKey":"honsan_cloud_ccprec","clientKey":"rtvgyzn6jgw62lnx","token":null,"clientDailyData":{},"acts":[{"id":"rtvgyznt9dcgvsio","fullPath":"/ccprec.com.cn.web/api/v3/web/addVisitsStatistics","args":["/index/projectSecPage/cqzr",1]},{"id":"rtvgyznterk2zlok","fullPath":"/ccprec.com.cn.web/client/info/cqweb_nonphy_cqzr","args":[${page},20,null]}]}`
    aes = new g;
    return aes.encode(a)
}
