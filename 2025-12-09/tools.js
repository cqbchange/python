...
createConstructor("Document", true, [], {
    createElement: function (tag_name) {
        ...
        if (tag_name === 'script') {
            return watch(new HTMLScriptElement({parentNode: watch(new HTMLHeadElement({removeChild: function () {}}, null, CONSTRUCTOR_TOKEN), 'parentNode head')
...
createConstructor("Document", true, [], {
    createElement:function (tag_name){
        if(tag_name==='script'){
            return watch(new HTMLScriptElement({parentNode:watch(new HTMLHeadElement({removeChild:function (){}},null,CONSTRUCTOR_TOKEN),'parentNode head')},null,CONSTRUCTOR_TOKEN),'script')
        }
        console.log("Document createElement:", tag_name);
    },
...
// 实例化document
window.document = watch( new HTMLDocument(null,null,CONSTRUCTOR_TOKEN),'window')
